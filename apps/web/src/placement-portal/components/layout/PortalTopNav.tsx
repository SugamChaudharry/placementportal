...
import { Av } from "@/placement-portal/components/atoms";
import { PRIMARY } from "@/placement-portal/constants";
import { NOTIFS } from "@/placement-portal/mock-data";
...
const pageTitles: Record<string, string> = {
  ...
  settings: "Settings",
  "rec-dashboard": "Recruiter Dashboard",
  "rec-company": "Company Profile",
  "rec-post": "Post a Job",
  "rec-drives": "Manage Drives",
  "rec-candidates": "Candidates",
  "rec-tests": "Create Test",
    ...
    <div className="flex items-center justify-between bg-white border-b border-gray-100 px-6" style={{ height: 60, flexShrink: 0 }}>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          {showNotifs && (
            <div
              className="absolute right-0 top-12 w-80 bg-white rounded-xl shadow-2xl border border-gray-100 z-50 fi"
            ...
            >
              ...
              {NOTIFS.slice(0, 4).map((n) => (
                <div
                  key={n.id}
                  className="flex gap-3 px-4 py-3 hover:bg-gray-50 cursor-pointer border-b border-gray-50"
                  style={{ borderLeft: n.unread ? `3px solid ${PRIMARY}` : "3px solid transparent" }}
                >
              ...
              <button
                ...
                className="w-full text-center py-3 text-xs font-medium"
                style={{ color: PRIMARY }}
              >
        ...
        <div className="flex items-center gap-2 cursor-pointer group">
          <Av name="Arjun Kumar" size={32} />
          <div className="hidden md:block">
            <p className="text-xs font-600" style={{ fontWeight: 600, lineHeight: 1.2 }}>
              Arjun Kumar
            </p>
